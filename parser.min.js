caterwaul.module("parser",function(a){(function(){var g=a.gensym("memo"),f=0,c=function(i,h){return(function(){var j=!!i[g]||(i[g]=++f),k=h.id(),m=h.memo_table(),l=("@"+(k)+"_"+(j)+""),n=j&&k&&m.hasOwnProperty(l)?m[l]:(m[l]=i([h]));
...
}return T}).call(this,P):[(N).concat(([null]))]:[N])}).call(this))))}return L}).call(this,I)}},q=function(H){return function(I){return(function(K){var N,M,J,O,L;
for(var L=new K.constructor(),J=0,O=K.length;J<O;++J){N=K[J],L.push.apply(L,Array.prototype.slice.call(((function(){var Q=(function(R){return(R&&c(H,R))}).call(this,(N[N.length-1])),P=Q&&Q.length;
return(Q?P?P===1?N.push(Q[0])&&[N]:(function(T){var R,V,S,W,U;for(var U=new T.constructor(),S=0,W=T.length;S<W;++S){R=T[S],U.push(((N).concat(([R]))))}return U}).call(this,Q):N.push(null)&&[N]:[N])
}).call(this))))}return L}).call(this,I)}},r=function(H){return(function(J){var N,M,I,O,L;for(var N=J[0],I=0,O=J.length,K;I<O;++I){N=J[I];if(K=(N[N.length-1])){return K
}}return false}).call(this,H)},h=function(H){return(function(J){var M,L,I,N,K;for(var K=new J.constructor(),I=0,N=J.length;I<N;++I){M=J[I],K.push((M[M.length-2].map(function(O){return(function(R){var P,T,Q,U,S;
for(var S=new R.constructor(),Q=0,U=R.length;Q<U;++Q){P=R[Q],S.push((P.value()))}return S}).call(this,M.slice(1,M.length-1))})))}return K}).call(this,H[H.length-1])
},v=function(){var H=function(I){return I};(e(H,"zero",[]));return H},o=function(){var H=function(I){return[]};(e(H,"fail",[]));return H},p=function(I){var H=function(J){return(function(M){var K,O,L,P,N;
for(var N=new M.constructor(),L=0,P=M.length;L<P;++L){K=M[L],(c(I,K).length)&&N.push(K)}return N}).call(this,J)};(e(H,"match",[I]));return H},m=function(I){var H=function(J){return(function(M){var K,O,L,P,N;
...
}).call(this,(this)):(function(p){return(p.i=q,p.p=m,p.v=i,p.table={}),p}).call(this,(this))},l=function(o){return{id:function(){return !!this.cached_id||(this.cached_id=j.call(this))
